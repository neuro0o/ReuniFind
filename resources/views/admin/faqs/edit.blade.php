...
<div class="layout">
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            <form action="{{ route('admin.faqs.update', $faq->faqID) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('faqQuestion', $faq->faqQuestion) }}"
                           required
                           maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <textarea name="faqAnswer" 
                              ...
                              required
                              rows="6">{{ old('faqAnswer', $faq->faqAnswer) }}</textarea>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-check"></i> Update FAQ
                    </button>
